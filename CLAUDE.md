...
- Этапы 1–5 готовы (каркас, CRUD, подбор — ADR 0005, автозаполнение из iTunes — ADR 0006,
  публикация и режим зрителя — ADR 0007). Этап 7 начат: визуал «Перламутр и стекло» (ADR 0008).
  100 unit-тестов, 23 e2e-сценария, сборка зелёная. Формат данных — версия 2.
